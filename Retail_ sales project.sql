...
-- To check transaction_id column has any null value or not.
SELECT * FROM retail_sales 
...
-- To check each and every column has any null value or not
SELECT * FROM retail_sales 
...
-- To check all the column having any null value or not in a single queries
...
-- To delect all the null value from the table
